// FM7Synth : OSCModule {
// 	classvar <>xyData, <>synthParams, <>regressor, <>fm7Presets, path, grainBuf;
//
//
...
//
// 			//validation
// 			TextField(presetGuiMain, Rect(10, 160, 75, 75/4)).action = {arg i; regressor.validation_(i.value.asFloat)};
// 			StaticText(presetGuiMain, Rect(10, 140, 75, 75/4)).string = "Validation";
//
// 			TextField(presetGuiMain, Rect(10, 200, 75, 75/4)).action = {arg i; regressor.learnRate_(i.value.asFloat)};
// 			StaticText(presetGuiMain, Rect(10, 180, 75, 75/4)).string = "learnRate";
//
// 			TextField(presetGuiMain, Rect(100, 160, 75, 75/4)).action = {arg i; regressor.maxIter_(i.value.asFloat)};
// 			StaticText(presetGuiMain, Rect(100, 140, 75, 75/4)).string = "maxIter";
//
// 			TextField(presetGuiMain, Rect(100, 200, 75, 75/4)).action = {arg i; regressor.batchSize_(i.value.asFloat)};
// 			StaticText(presetGuiMain, Rect(100, 180, 75, 75/4)).string = "batchSize";
//
// 			TextField(presetGuiMain, Rect(200, 200, 75, 75/4)).action = {arg i; regressor.hiddenLayers_(i.value.interpret)};
// 			StaticText(presetGuiMain, Rect(200, 180, 80, 75/4)).string = "hiddenLayers";
//
// 			TextField(presetGuiMain, Rect(10, 240, 75, 75/4)).action = {arg i; regressor.activation_(i.value.asInteger)};
// 			StaticText(presetGuiMain, Rect(10, 220, 75, 75/4)).string = "activation";
//
// 			TextField(presetGuiMain, Rect(100, 240, 75, 75/4)).action = {arg i; regressor.outputActivation_(i.value.asInteger)};
// 			StaticText(presetGuiMain, Rect(100, 220, 100, 75/4)).string = "outputActivation";
//
// 			TextField(presetGuiMain, Rect(210, 240, 75, 75/4)).action = {arg i; regressor.momentum_(i.value.asFloat)};
